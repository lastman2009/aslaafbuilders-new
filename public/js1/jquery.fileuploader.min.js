...
!function ($) {
    ...
    $.fn.fileuploader = function (q) {
        return this.each(function (t, r) {
            var s = $(r), p = null, o = null, l = null, sl = [], n = $.extend(!0, {}, $.fn.fileuploader.defaults, q), f = {
                init: function () {
                    ...
                    switch (a) {
                        ...
                        case"disabled":
                            ...
                            break;
                        case"feedback":
                            b || (b = f._assets.textParse(f._itFl.length > 0 ? n.captions.feedback2 : n.captions.feedback, {length: f._itFl.length})), $(!o.is(":file")) && o.find(".fileuploader-input-caption span").html(b);
                            break;
                        case"input":
                    ...
                    if (f.clipboard._timer && f.clipboard.clean(), !f.isDefaultMode() || (f.reset(), 0 != c.length)) {
                        ...
                        for (var d = 0, e = 0; e < c.length; e++) {
                            ...
                            if (!0 === i) n.thumbnails && f.thumbnails.item(h), f.isUploadMode() && f.upload.prepare(h), n.onSelect && $.isFunction(n.onSelect) && n.onSelect(h, l, p, o, s), d++; else if (f.files.remove(h, !0), i[2] || (f.isDefaultMode() && (f.set("input", ""), f.reset(), i[3] = !0), i[1] && n.dialogs.alert(i[1])), i[3])break
                        }
                    ...
                    create: function () {
                        ...
                        l = a.is(n.thumbnails._selectors.list) ? a : a.find(n.thumbnails._selectors.list), f.isUploadMode() && n.thumbnails._selectors.start && l.on("click", n.thumbnails._selectors.start, function (a) {
                            ...
                            if (a.preventDefault(), f.locked)return !1;
                            var b = $(this).closest(n.thumbnails._selectors.item), c = f.files.find(b), d = function (a) {
                                f.files.remove(c)
                            };
                        ...
                        var c = '<div style="${style}" class="fileuploader-item-icon${class}"><i>' + (b || "") + "</i></div>", d = f._assets.textToColor(b);
                        if (d) {
                        ...
                        var c = a.html.find(".fileuploader-item-image"), d = function (b) {
                            ...
                            var b = 0;
                            if (a && f._pfrL.indexOf(a) > -1)for (f._pfrL.splice(f._pfrL.indexOf(a), 1); b < f._pfrL.length;) {
                        ...
                        if (a.image = c, "image" == a.format && f.isFileReaderSupported() && (a.appended || n.thumbnails.startImageRenderer || b)) {
                            ...
                            var h = new FileReader, i = function (a) {
                                if (n.thumbnails.canvasImage) {
                                    ...
                                    i.onload = function () {
                                        var a = n.thumbnails.canvasImage.height ? n.thumbnails.canvasImage.height : c.height(), j = n.thumbnails.canvasImage.width ? n.thumbnails.canvasImage.width : c.width(), k = i.height / a, l = i.width / j, m = k < l ? k : l, o = i.height / m, p = i.width / m, q = Math.ceil(Math.log(i.width / p) / Math.log(2));
                                        if (b.height = a, b.width = j, i.width < b.width || i.height < b.height || q <= 1) {
                                            var r = i.width < b.width ? b.width / 2 - i.width / 2 : i.width > b.width ? -(i.width - b.width) / 2 : 0, s = i.height < b.height ? b.height / 2 - i.height / 2 : 0;
                    ...
                    prepare: function (a, b) {
                        ...
                        if (a.upload) {
                            var c = function (b) {
                                ...
                                var b = 0;
                                if (f._pfuL.length > 0)for (f._pfuL.indexOf(a) > -1 && f._pfuL.splice(f._pfuL.indexOf(a), 1); b < f._pfuL.length;) {
                            ...
                            if (n.upload.synchron)if (a.upload.status = "pending", a.html && c(), b) f._pfuL.indexOf(a) > -1 && f._pfuL.splice(f._pfuL.indexOf(a), 1); else if (-1 == f._pfuL.indexOf(a) && f._pfuL.push(a), f._pfuL.length > 1)return;
                            if (n.upload.beforeSend && $.isFunction(n.upload.beforeSend) && !1 === n.upload.beforeSend(a, l, p, o, s))return c(), void d();
                            if (p.addClass("fileuploader-is-uploading"), a.upload.$ajax && a.upload.$ajax.abort(), delete a.upload.$ajax, delete a.upload.send, a.upload.status = "loading", a.html && (n.thumbnails._selectors.start && a.html.find(n.thumbnails._selectors.start).remove(), c()), a.upload.data)for (var e in a.upload.data)a.upload.formData.append(e, a.upload.data[e]);
                            a.upload.data = a.upload.formData, a.upload.xhr = function () {
                                ...
                                a.uploaded = !0, delete a.upload, a.upload = {status: "successful"}, a.html && c(), f.set("listInput", null), null != n.upload.onSuccess && $.isFunction(n.upload.onSuccess) && n.upload.onSuccess(b, a, l, p, o, s, d, e)
                        ...
                        if (a.lengthComputable) {
                            var d = a.loaded, e = a.total, g = Math.round(100 * d / e), h = ((new Date).getTime() - c.getTime()) / 1e3, i = h ? d / h : 0, j = e - d, k = h ? j / i : null, m = {
                                loaded: d,
                    ...
                    paste: function (a) {
                        if (f._assets.isIntoView(o) && a.originalEvent.clipboardData && a.originalEvent.clipboardData.items && a.originalEvent.clipboardData.items.length) {
                            ...
                            f.clipboard.clean();
                            for (var c = 0; c < b.length; c++)if (-1 !== b[c].type.indexOf("image") || -1 !== b[c].type.indexOf("text/uri-list")) {
                                var d = b[c].getAsFile(), e = new Date, g = function (a) {
                                    return a < 10 && (a = "0" + a), a
                                }, h = n.clipboardPaste > 1 ? n.clipboardPaste : 2e3;
                                d && (d._name = "Clipboard " + e.getFullYear() + "-" + g(e.getMonth() + 1) + "-" + g(e.getDate()) + " " + g(e.getHours()) + "-" + g(e.getMinutes()) + "-" + g(e.getSeconds()), d._name += -1 != d.type.indexOf("/") ? "." + d.type.split("/")[1].toString().toLowerCase() : ".png", f.set("feedback", f._assets.textParse(n.captions.paste, {ms: h / 1e3})), f.clipboard._timer = setTimeout(function () {
                    ...
                    bytesToText: function (a) {
                        ...
                        var c = Math.floor(a / 3600), d = Math.floor((a - 3600 * c) / 60), a = a - 3600 * c - 60 * d, e = "";
                        ...
                        var b = $(window).scrollTop(), c = b + window.innerHeight, d = a.offset().top, e = d + a.outerHeight();
                        return b < d && c > e
                        ...
                        switch (opts = noOptions ? opts || {} : $.extend({}, {
                            ...
                            case"string":
                                text = text.replace(/\$\{(.*?)\}/g, function (match, a) {
                                    var a = a.replace(/ /g, ""), r = void 0 !== opts[a] && null != opts[a] ? opts[a] : "";
                                    if (a.indexOf(".") > -1 || a.indexOf("[]") > -1) {
                                        var x = a.substr(0, a.indexOf(".") > -1 ? a.indexOf(".") : a.indexOf("[") > -1 ? a.indexOf("[") : a.length), y = a.substring(x.length);
                                        if (opts[x])try {
                                            r = eval('opts["' + x + '"]' + y)
                                        } catch (a) {
                                            r = ""
