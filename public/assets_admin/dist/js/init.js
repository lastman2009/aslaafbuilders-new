/** *************Init JS*********************
 ...
 4.onlinePropertyPortal function
 5.Chat App function
 6.Resize function
 ** ***************************************/
...
/***** onlinePropertyPortal function start *****/
var $wrapper = $(".wrapper");
var onlinePropertyPortal = function () {
    ...
    var timer;
    $(document).on("mouseenter", "wrapper > .fixed-sidebar-left", function(){
        timer = setTimeout(function () {
            $wrapper.addClass("sidebar-hover");
        }, 2000);
    }).on("mouseleave", ".wrapper > .fixed-sidebar-left", function(){
        clearTimeout(timer);
...
/***** onlinePropertyPortal function end *****/
...
$('#toggle_nav_btn').click(function () {
    $('.fixed-sidebar-left').toggleClass('expand-bar collapse-bar');
});

//$(document).ready(function(){
//    $("div.note-toolbar div:nth-child(5) button:first-child").click(function(){
//        $('.note-editable.panel-body ul').css({
//			"list-style": "disc",
//			"font-size": "45px",
//			"color": "black",
//			"list-style-type": "disc",
//		});
//		$('.note-editable.panel-body ul li').css({
//			"list-style-type": "disc",
//		});
//    });
//});
