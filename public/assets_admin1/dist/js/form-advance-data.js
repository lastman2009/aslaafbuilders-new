...
$('#select-tag-all').click(function(){
$('#pre-selected-options').multiSelect('select_all');
return false;
});
$('#deselect-tag-all').click(function(){
...
$('#public-methods,#pre-selected-options, #multi-tags, #multi-category').multiSelect('refresh');
return false;
});
$('#add-option').on('click', function(){
$('#public-methods,#pre-selected-options, #multi-tags, #multi-category').multiSelect('addOption', { value: 42, text: 'test 42', index: 0 });
return false;
});
