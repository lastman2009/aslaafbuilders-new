                                    ...
                                    <div class="row">
                                       <div class="col-md-12 padding-right">
                                           <ul class="donate-now list-inline">
                                                <li style="width:48%;">
                                                    <input type="radio" id="a25" class="radio-btn" name="identifier" value="0" checked="checked"/>
                                                    <label for="a25">For Blog</label>
                                                </li>
                                                <li style="width:48%;">
                                                    <input type="radio" class="radio-btn" id="a50" name="identifier" value="1"/>
                                                    <label for="a50">For News</label>
                                                </li>
                                          ...
                                          <div class="col-md-12 padding-left">
                                             <div class="form-group">
                                                <input type="text" id="" name="author_name" value="" placeholder="Blog Author Name" required />
