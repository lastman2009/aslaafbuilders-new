...
<head>
    ...
    <title>Fancy Orange Theme</title>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/slider-1_02.jpg" alt="Los Angeles" style="width:100%;">
                    <div class="carousel-caption cap">

                        <h2>FIND&nbsp;<span>YOUR</span>&nbsp;PERFECT<span>&nbsp;HOME</span>&nbsp;TODAY</h2>
                        <p>FIND YOUR PERFACT HOME TODAY</p>
                    </div>
                </div>

                <div class="item">
                    <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/cover-1.jpg" alt="Chicago" style="width:100%;">
                    <div class="carousel-caption cap">
                        <h2>FIND&nbsp;<span>YOUR</span>&nbsp;PERFECT<span>&nbsp;HOME</span>&nbsp;TODAY</h2>
                        <p>FIND YOUR PERFACT HOME TODAY</p>
                    </div>
                ...
                <div class="item">
                    <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/cover-2.jpg" alt="New York" style="width:100%;">
                    <div class="carousel-caption cap">
                        <h2>FIND&nbsp;<span>YOUR</span>&nbsp;PERFECT<span>&nbsp;HOME</span>&nbsp;TODAY</h2>
                        <p>FIND YOUR PERFACT HOME TODAY</p>
                    </div>
                ...
                <div class="item">
                    <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/cover-3.jpg" alt="New York" style="width:100%;">
                    <div class="carousel-caption cap">
                        <h2>FIND&nbsp;<span>YOUR</span>&nbsp;PERFECT<span>&nbsp;HOME</span>&nbsp;TODAY</h2>
                        <p>FIND YOUR PERFACT HOME TODAY</p>
                    </div>
                ...
                <div class="item">
                    <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/cover-4.jpg" alt="New York" style="width:100%;">
                    <div class="carousel-caption cap">
                        <h2>FIND&nbsp;<span>YOUR</span>&nbsp;PERFECT<span>&nbsp;HOME</span>&nbsp;TODAY</h2>
                        <p>FIND YOUR PERFACT HOME TODAY</p>
                    </div>
                    ...
                    <div class="col-lg-12  pr">
                        <div class="col-md-4 col-sm-6 workportion pl">
                            <figure class="internal-sec">
                                <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/2nd-Theme-v1_07.jpg" class="imgs">
                                <div class="overlay">
                                    <div class="text">
                        ...
                        <div class="col-md-4 col-sm-6 workportion pl">
                            <figure class="internal-sec">
                                <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/2nd-Theme-v1_09.jpg" class="imgs">
                                <div class="overlay">
                                    <div class="text">
                                        <p>5 MARLA <span>HOUSE FOR</span> SALE</p>
                                        <p>PRICE:<span>RS:25418</span></p>
                        ...
                        <div class="col-md-4 col-sm-6 workportion pl">
                            <figure class="internal-sec">
                                <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/2nd-Theme-v1_06.png" class="imgs">
                                <div class="overlay">
                                    <div class="text">
                                        <p>5 MARLA <span>HOUSE FOR</span> SALE</p>
                                        <p>PRICE:<span>RS:25418</span></p>
                        ...
                        <div class="col-md-4 col-sm-6 workportion pl">
                            <figure class="internal-sec">
                                <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/2nd-Theme-II_04.png" class="imgs">
                                <div class="overlay">
                                    <div class="text">
                                        <p>5 MARLA <span>HOUSE FOR</span> SALE</p>
                                        <p>PRICE:<span>RS:25418</span></p>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content about-content">
                            ...
                            <div id="menu1" class="tab-pane fade">
                                <h3>ABOUT US</h3>
                                    <div class="mCustomScrollbar">
                                        <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatUt enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat .</p>
                                    </div>
                                </div>
                        </div>
                    </div>
                                ...
                                <ul class="nav nav-tabs tabs">
                                    <li class="col-md-4 col-sm-4 pl img-hover active">
                                        <a href="#Cube" data-toggle="tab">
                                            <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-img-1_13.jpg" class="img=responsive team-img">
                                        </a>
                                    ...
                                    <li class="col-md-4 col-sm-4 pl img-hover">
                                        <a href="#Rollcake" data-toggle="tab">
                                            <img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-img-2_13.jpg" class="img=responsive team-img">
                                        </a>
                                        <a href="#" class="fb-lnk"><span><i class="fa fa-facebook" aria-hidden="true"></i></span></a>
                                    </li>
                                    <li class="col-md-4 col-sm-4 pl img-hover">
