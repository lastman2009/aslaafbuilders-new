...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="top-bar">
                                ...
                                <div class="col-md-2 col-sm-12">
                                    ...
                                    <ul>
                                        ...
                                        <li><span><i class="fa fa-mobile"></i></span> +923114065583</li>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <ul>
                                        ...
                                        <li><span><i class="fa fa-home"></i></span> Dha phase 4 , ff block, house 43.</li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 banner-text">
                        ...
                        <h1>We bring you the best real estate solution</h1>

                        <p>Offer you best service in lahore</p>
        ...
        <div class="main">
						...
						<div class="col-lg-12">
							...
							<div class="owl-carousel">
								...
								<div class="item">
									...
									<h3>Beautiful House in Cantt</h3>
									...
									<ul>
										...
										<li><i class="fa fa-bed" aria-hidden="true"></i> 4 Bedrooms</li>

										<li><i class="fa fa-area-chart" aria-hidden="true"></i> 1200 Sqr Yrds</li>

										<li><i class="fa fa-bath" aria-hidden="true"></i> 4 Bathrooms</li>
									...
									<figure>
										...
										<div class="abc">
											...
											<a href="#">
												...
												<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-1.jpg" alt="ceo-image" />
									...
									<figure>
										...
										<div class="abc">
											...
											<a href="#">
												...
												<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-2.jpg" alt="ceo-image" />
									...
									<figure>
										...
										<div class="abc">
											...
											<a href="#">
												...
												<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-3.jpg" alt="ceo-image" />
									...
									<figure>
										...
										<div class="abc">
											...
											<a href="#">
												...
												<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-4.jpg" alt="ceo-image" />
			...
			<section class="tab-section" id="about">
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4 col-md-4 office-addresses">
									...
									<ul>
										...
										<li>Princeton Home Marketing Center 253 Nassau Street, Princeton, NJ 08540</li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/logo.png" alt="" />
