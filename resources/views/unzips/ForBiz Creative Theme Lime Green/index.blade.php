...
<head>
    ...
    <link href="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/css/theme.css" rel="stylesheet">
    <link href="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/css/custom.css" rel="stylesheet">
    <style>
        .banner{
            <?php 
                $active_index = 0;
            ...
            @if(!$agencyWebsite->Images->isEmpty())
                ...
                @endif
            @else
                background-image: url(../unzips/ForBiz%20Creative%20Theme%20Lime%20Green/images/banner.jpg);
            @endif
            height:750px;
            position:relative;
...
<script src="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/js/jquery-3.2.1.min.js"></script>
<script src="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/js/jquery-migrate-3.0.0.js"></script>
<script src="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/js/bootstrap.min.js"></script>
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
<script src="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/js/owl.carousel.js"></script>
<!-- custom scrollbar plugin --><script src="/unzips/ForBiz%20Creative%20Theme%20Lime%20Green/js/jquery.mCustomScrollbar.concat.min.js"></script>
<?php
