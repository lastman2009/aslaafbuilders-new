...
<head>
    ...
    <link href="/unzips/Green%20Structures%20Theme/css/theme.css" rel="stylesheet">
    <link href="/unzips/Green%20Structures%20Theme/css/custom.css" rel="stylesheet">
</head>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="col-md-6 property-content no-padding">
                                                <div class="slider-content">
                                                    ...
                                                    <p>
                                                        {{App\Property::getCityName($property->city_id)}}, {{App\Property::getTownName($property->town_id)}}, {{App\Property::getPhaseName($property->phase_id)}}
                                                    </p>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="tab-content clearfix ">
                                        <div class="tab-pane active nano" id="about-content">
                                            <?php
                                                $doc = new DOMDocument();
                            ...
                            <div class="col-lg-12 ">
                                <div id="office-address" class="nano contactus col-md-4 col-sm-4 col-xs-12">
                                    <div class="nano-content">
                                        ...
                                        <ul class="pl">
                                            <h2><span>{{$office->city}} Office</span></h2>
                                ...
                                <div class="col-md-4 bottom-logo col-sm-4 col-xs-12">
                                    ...
                                    <p>
                                          @if(strlen($agencyWebsite->about_us) <= 200)
                                              {{$agencyWebsite->about_us}}
                                          @else
                                              <?php echo substr(strip_tags($agencyWebsite->about_us),0,200).'......';?>
                                          @endif
                                    </p>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $("#about-content").nanoScroller();
    $("#ceo-content").nanoScroller();
});
</script>
<script>
