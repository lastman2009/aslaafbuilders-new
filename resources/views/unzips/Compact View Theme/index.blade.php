...
<head>
    ...
    <link href="/unzips/Compact%20View%20Theme/css/bootstrap.min.css" rel="stylesheet">
    <link href="/unzips/Compact%20View%20Theme/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="/unzips/Compact%20View%20Theme/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="/unzips/Compact%20View%20Theme/css/jquery.mCustomScrollbar.css">
    <link href="/unzips/Compact%20View%20Theme/css/theme.css" rel="stylesheet">
    <link href="/unzips/Compact%20View%20Theme/css/custom.css" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 banner-text">
                    ...
                    <p>This is the best portal for you. Your can find your favourite house to visit our portal. Look on the complete info we are providing.</p>
                    <div class="banner-button">
                        <a href="javascript:void(0);">
								<img src="/unzips/Compact%20View%20Theme/images/drop-drow.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="team-title text-center">
                            ...
                            <p>We have professionals. Those find best houses for you on best locality.</p>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 pr">
                        <div class="contact-title text-center">
                            <h2>Contact us</h2>
                            <p>Feel free to contact us to send use your choice. We will soon entertain your choice.</p>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="work-title text-center">
                            <h2>Our Work</h2>
                            <p>View proeprties those are purchased or rented by the clients.</p>
                        </div>
                        <div class="col-lg-12  pr">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-4  col-md-4 office-addresses">
                            <h4><img class="img-responsive" src="/images/logo/{{$agencyWebsite->logo}}" alt="{{$agencyWebsite->agency_name}}-logo"></h4>
                            <p>
                        ...
                        <div class="col-lg-4  col-md-4 col-xs-12 office-addresses follow">
                            <h1>Follow on</h1>
                            <p>Follow us on the following to view our posts for latest properties and projects. You can find the best option for you.</p>
                            <ul>
    ...
    <script src="/unzips/Compact%20View%20Theme/js/jquery-3.2.1.min.js"></script>
    <script src="/unzips/Compact%20View%20Theme/js/bootstrap.min.js"></script>
    <script src="/unzips/Compact%20View%20Theme/js/owl.carousel.js"></script>
    <script type="text/javascript" src="/unzips/Compact%20View%20Theme/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script>
