...
<head>
    ...
    <link href="/unzips/Slanting%20Theme%20Pro%20Dark%20Red/css/theme.css" rel="stylesheet">
    <link href="/unzips/Slanting%20Theme%20Pro%20Dark%20Red/css/custom.css" rel="stylesheet">
</head>
                    ...
                    <div class="col-lg-12 pr">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 about-img-section pl">
                            <div class="img-container">
                                <div class="img-block">
                                    <img class="img-responsive" src="/unzips/Slanting%20Theme%20Pro%20Dark%20Red/images/about-img.jpg" alt="About {{$agencyWebsite->agency_name}}"></div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <figure>
                                    ...
                                    <div class="abc">
                                        <a href="/property/{{App\Property::getPurpose($property->purpose)}}/{{App\Property::getCityName($property->city_id)}}/{{App\Property::getTownName($property->town_id)}}/{{App\Property::getTitleSlug($property->title)}}/{{$property->id}}">
                                            ...
                                            <span class="facebook-icon"><img src="/unzips/Slanting%20Theme%20Pro%20Dark%20Red/images/project-open.png" alt=""></span>
                                    ...
                                    <figcaption>
                                        ...
                                        <div class="team-detail">
                                            <div class="col-md-6 col-sm-6 team-description pl pr">
                                                <a href="">
														<img src="/unzips/Slanting%20Theme%20Pro%20Dark%20Red/images/team-phone.png" alt=""><p>{{$staff->contact_number}}</p>
													</a>
                                            </div>
                                            <div class="col-md-6 col-sm-6 team-description pl pr">
                                                <a href="">
														<img class="team-service-img" src="/unzips/Slanting%20Theme%20Pro%20Dark%20Red/images/team-service.png" alt=""><p>{{$staff->year_of_service}} Year services</p>
													</a>
                                            </div>
                                        </div>
                                    </figcaption>
