...
<head>
    ...
    <link href="/unzips/Business%20Oriented%20Theme/css/theme.css" rel="stylesheet">
    <link href="/unzips/Business%20Oriented%20Theme/css/custom.css" rel="stylesheet">
                            ...
                            <div class="item">
                                <div class="carousel-content">
                                    <div class="text-center">
                                        ...
                                        <p class="address"><span><i class="fa fa-map-marker" aria-hidden="true"></i></span> {{App\Property::getTownName($property->town_id)}} {{App\Property::getPhaseName($property->phase_id)}} {{App\Property::getCityName($property->city_id)}}</p>
                                        <p class="color">
                                          <?php
                                        ...
                                        <a class="view-lnk" href="/property/{{App\Property::getPurpose($property->purpose)}}/{{App\Property::getCityName($property->city_id)}}/{{App\Property::getTownName($property->town_id)}}/{{App\Property::getTitleSlug($property->title)}}/{{$property->id}}">View</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                                ...
                                <ul class="slides">
                                    ...
                                    <li>
                                        <div class="address-office">
                                            ...
                                            <ul>
                                                <li><i class="fa fa-phone"></i> {{$office->telephone}} {{$office->mobile_no}}</li>
