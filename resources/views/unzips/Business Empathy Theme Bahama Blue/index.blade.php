...
<head>
    ...
    <link href="/unzips/Business%20Empathy%20Theme%20Bahama%20Blue/css/theme.css" rel="stylesheet">
    <link href="/unzips/Business%20Empathy%20Theme%20Bahama%20Blue/css/custom.css" rel="stylesheet">
        ...
        <section class="aboutus-sect" id="about">
            <div class="container-fluid text-center no-padding">
                <div id="main-title" style="background-position: -3182px center;" class="text-center section-padding main-title">
                    <h2>About Us</h2>
                    <img src="/unzips/Business%20Empathy%20Theme%20Bahama%20Blue/images/stick_03.jpg"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <section class="property-sect" id="work">
            <div class="container-fluid no-padding">
                <div id="seconed-title" style="background-position: -3182px center;" class="text-center section-padding main-title">
                    <h2>Our Work</h2>
                    <img src="/unzips/Business%20Empathy%20Theme%20Bahama%20Blue/images/stick_03.jpg">
                </div>
                <div class="container">
                    <div class="row">
