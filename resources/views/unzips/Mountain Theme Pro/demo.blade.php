   	...
   	<div class="home-content-table">	
		   ...
		   <div class="home-content-tablecell">
		   	...
		   	<div class="row">
		   		...
		   		<div class="col-twelve">		   			
			  				...
			  				<h1 class="animate-intro">Our House</h1>

				  			<h3 class="animate-intro">In The World Top Beautiful Place</h3>	

				  			<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/banner-line.png" alt="">					
		...
		<ul class="home-social-list">
	      ...
	      <li>
	        ...
	        <!-- <li><a href="javascript:void(0);" title="Facebook" data-toggle="popover" data-placement="right" data-content="facebook.com"><i class="fa fa-facebook"></i></a></li>

            <li><a href="javascript:void(0);" title="E-mail" data-toggle="popover" data-placement="right" data-content="atif502@gmail.com"><i class="fa fa-envelope"></i></a></li>

            <li><a href="javascript:void(0);" title="Phone Number" data-toggle="popover" data-placement="right" data-content="03128857156"><i class="fa fa-mobile mob"></i></a></li> -->
   	...
   	<div class="row portfolio-content">
   		...
   		<div class="col-twelve">
   			...
   			<div id="folio-wrap" class="bricks-wrapper">					
	               ...
	               <div class="item-wrap animate-this" data-src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-1.jpg" data-sub-html="#01" > 	

	                  <a href="#" class="overlay">

	                  	<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-1.jpg" alt="">	                     
	                     ...
	                     <div class="item-text">
	                     	...
	                     	<span class="folio-types">
		     					   ...
		     					   <h3 class="folio-title">Muhammad Usman</h3>	     					   

		     					   <h3 class="folio-title">3 Year of service</h3>	     					   
	               ...
	               <div class="item-wrap animate-this" data-src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-2.jpg" data-sub-html="#02"> 	

	                  <a href="#" class="overlay">

	                  	<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-2.jpg" alt="">	                     
	               ...
	               <div class="item-wrap animate-this" data-src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-4.jpg" data-sub-html="#03" >   	

	                  <a href="#" class="overlay">

	                  	<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-4.jpg" alt="">	                     
	               ...
	               <div class="item-wrap animate-this"  data-src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-3.jpg"  data-sub-html="#04" >

	                  <a href="#" class="overlay">

	                  	<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-3.jpg" alt="">	                     
	               ...
	               <div class="item-wrap animate-this"  data-src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-6.jpg"  data-sub-html="#05" >  	

	                  <a href="#" class="overlay">

	                  	<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-6.jpg" alt="">	                     
	               ...
	               <div class="item-wrap animate-this"  data-src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-5.jpg"  data-sub-html="#06">     	

	                  <a href="#" class="overlay">

	                  	<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/team-5.jpg" alt="">	                     
			    	...
			    	<figure>
						...
						<div class="abc">
							...
							<a href="#">
								...
								<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/work-1.jpg" alt="" />

								<div class="facebook-icon">

									<div class="team-text">

										<h2>Whitley Residences.</h2>

										<img src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/line.jpg" alt="">

										<ul>

											<li>Project</li><span>|</span>

											<li>Rs. 2345678</li>

											<li>2 Kanal</li><span>|</span>
			    	...
			    	<figure>
						...
						<div class="abc">
							...
							<a href="#">
								...
								<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/work-2.jpg" alt="" />
			    	...
			    	<figure>
						...
						<div class="abc">
							...
							<a href="#">
								...
								<img class="img-responsive" src="<?php public_path(); ?>/unzips/{{ $theme_name }}/images/work-3.jpg" alt="" />
