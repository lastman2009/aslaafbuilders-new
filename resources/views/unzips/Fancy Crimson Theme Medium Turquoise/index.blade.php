...
<head>
    ...
    <link href="/unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/css/theme.css" rel="stylesheet">
    <link href="/unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/css/custom.css" rel="stylesheet">
    <style>
        .banner{
            <?php 
                $active_index = 0;
            ...
            @if(!$agencyWebsite->Images->isEmpty())
                ...
                @endif
            @else
                background-image: url(../unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/images/banner.jpg);
            @endif
            height:750px;
            position:relative;
...
<script src="/unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/js/jquery-3.2.1.min.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/js/jquery-migrate-3.0.0.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/js/bootstrap.min.js"></script>
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Medium%20Turquoise/js/owl.carousel.js"></script>
