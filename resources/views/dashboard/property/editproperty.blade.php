...
<a href="javascript:void(0)" class="input-group-addon btn btn-danger fileinput-exists" data-dismiss="fileinput">
                                                        ...
                                                        <div class="col-md-12 padding-right">
                                                            ...
                                                            <div class="col-md-6 padding-left">
                                                                <div class="form-group date"
                                                                     id='datetimepicker1' >
                                                                    <input type="date"   name="expire_date" placeholder="Expiry Date" data-mask="99/99/9999" class="form-control">
                                                                </div>
