@php
$title = "Properties Approved List For Admin";
@endphp
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view user-list-section">
                    <div class="panel-wrapper collapse in">
                        ...
                        <h2>Active Property Listing For Admin </h2>
                                    ...
                                    <table id="datatable-userlist" class="table table-striped table-bordered mb-0">
                                        ...
                                        @foreach($properties as $property)
                                            <tr>
                                                ...
                                                <td>No Image</td>
                                                @endif
                                                <td><a href="/listPackagesForAd/{{$property->id}}" class="btn btn-sm add-property-featured">ADD</a></td>
