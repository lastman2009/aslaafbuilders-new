@php
$title = "In House Properties List";
@endphp
                                                           ...
                                                           @if($property->purpose == 1)
                                                            ...
                                                            <td>
                                                                ...
                                                                @endif  
                                                                 ...
                                                                 <a href="/dashboard/property/edit/{{App\Property::getId($property->id)}}" target="_blank"  data-toggle="tooltip" data-original-title="Edit"> 
                                                                    <i class="fa fa-pencil text-inverse "></i> 
                                                                </a>
                                                                @endif
                                                                
                                                              
                                                                <a href="{{$property->url}}/{{$property->id}}" class="toggleicon mr-5 " target="_blank" data-toggle="" data-original-title="View"> 
...
<script>
    $(document).ready(function () {
        ...
        $('.toggle-icon').click(function () {
            ...
            url ='/dashboard/propertyBlockorActive/'+id;
