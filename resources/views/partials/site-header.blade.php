    ...
    <header class="ab-header">
        <div class="ab-wrap">
            ...
            <nav class="ab-nav" id="ab-nav">
                ...
                <a href="/property-transfer-calculator" style="color:var(--ab-orange-dark);font-weight:600">Advanced Calculator</a>
            </nav>
            ...
            <div class="ab-head-actions">
                ...
                @if(empty(Auth::user()))
                <a class="ab-btn ab-btn-primary ab-btn-post-full" href="javascript:void(0)" onclick="abOpenModal('#loginModal','#fsModal2')">Post Property</a>
                <a class="ab-btn ab-btn-primary ab-btn-post-mobile" href="javascript:void(0)" onclick="abOpenModal('#loginModal','#fsModal2')" aria-label="Post Property">+</a>
                @else
                <a class="ab-btn ab-btn-primary ab-btn-post-full" href="/dashboard/property/add">Post Property</a>
                <a class="ab-btn ab-btn-primary ab-btn-post-mobile" href="/dashboard/property/add" aria-label="Post Property">+</a>
