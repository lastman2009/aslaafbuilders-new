													...
													<div class="theme-border to-active-theme">
														<figure>
															...
															<figcaption>
																...
																<h4 style="top: 45%"><a href="javascript:void(0)" class="sa-success" data-id="{{$theme->id}}"  >active now</a></h4>
																<!-- <h4><a href="javascript:void(0)" class="demo-success" data-id="{{$theme->id}}"  >Demo now</a></h4> -->
															<h4 style="top: 60%"><a href="demo-theme/{{$theme->id}}/{{str_slug($theme->name)}}" target="_blank"  >Demo View</a></h4>
															</figcaption>
														</figure>
													</div>
												</div>
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    swal( {
                        ...
                        type: "success",
                        text: "Please Wait For Your Theme Activation ",
                        confirmButtonColor: "#01c853",
                        customClass: "myAlert",
                    });
