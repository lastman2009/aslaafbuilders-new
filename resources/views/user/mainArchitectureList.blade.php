									...
									<div class="col-md-12 padding-right">
										<div class="col-md-6 padding-left">
											<div class="img-container">
												<div class="img-block">
										@if(!empty($lists->logo))
										@foreach(json_decode($lists->logo) as $image)
										...
										<div class="col-md-6 padding-left">
											<div class="agency-list-detail">
												<h2>{{$lists->name}} </h2>
													...
													<li><i class="fa fa-map-marker"></i>{{$lists->location}} </li>
												</ul>
												<div class="btn-agency-detail">
													<ul>
														<li><a href="javascript:void(0);" data-toggle="popover" title="Phone Number" data-content="@if(!empty($lists->telephone))
														{{$lists->telephone}}
														@else
															No Contact Given
														@endif"" data-placement="top">Phone</a></li>
														@if(Auth::check())
														<li><a class="agency-detail-view" href="/dashboard/architecture/pk1000-{{$lists->user_id}}/{{App\User::getFirstName($lists->user_id)}}"">View</a></li>
														@else
