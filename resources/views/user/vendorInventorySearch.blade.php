                ...
                <div class="panel panel-default card-view inventory-add-class-padding">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">    
                            <form action="/dashboard/vendor/search/result" method="post">
                            {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6 padding-left">
                                            <div class="form-group">
                                                <input type="text" class="form-control inventory-area" placeholder="Vendor Name" name="name">
                                            </div>
                                        </div>
                                        <div class="col-md-6 padding-left">
                                            <div class="form-group">
                                                <input type="text" class="form-control inventory-area" placeholder="Vendor ID" name="id">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 padding-left">
                                         ...
                                         <div class="col-md-6 padding-left">
                                            ...
                                            <select class="selectpicker" name="product" id="city" data-style="form-control btn-font btn-default btn-outline" title="--Search By Product--">
                                            
                                            @foreach($products as $product)
                                            <option value="{{$product->title}}">{{$product->title}}
                                            </option>
                                             @endforeach
                                        </select>
                                        </div>
                                    ...
                                    <table id="datable_property" class="table display  pb-30" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               {{--<td>{{$user_character_detail->product_name}}</td> --}}
                                               <td><a href="/dashboard/vendor/pk1000-{{$user_character_detail->user_id}}/{{$user_character_detail->name}}" class="pr-20" title="View" data-toggle="tooltip"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
