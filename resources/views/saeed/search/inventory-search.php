    ...
    <div class="container-fluid">
							...
							<form action="" method="post">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-6 padding-left">
											<div class="form-group">
												<input type="number" class="form-control inventory-area" placeholder="Type Area">
											</div>
										</div>
										<div class="col-md-6 padding-left">
											<div class="form-group">
										...
										<div class="col-md-3 padding-left">
											<div class="form-group">
												<input type="number" class="form-control inventory-area" placeholder="Rs. Min Price">
											</div>
										</div>
										<div class="col-md-3 padding-left">
											<div class="form-group">
												<input type="number" class="form-control inventory-area" placeholder="Rs. Max Price">
											</div>
										</div>
        ...
        <div class="row">
            <div class="col-lg-12 inventory-search">
                <div class="panel panel-default card-view inventory-add-class-padding">
                    <h6 class="panel-title inventory-add-class client-list-heading txt-dark">Inventory Search Result.</h6>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">	
