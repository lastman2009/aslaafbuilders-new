        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-6 form-group padding-right">
                ...
                <input class="form-control inout-size" type="text" id="name" placeholder="NAME">
             
            </div>

            <div class="col-md-6 form-group">
          
                <input class="form-control inout-size" type="email" id="email" placeholder="EMAIL">
             
            </div>

            <div class="col-md-6 form-group padding-right">
          
                <input class="form-control inout-size" type="text" id="phone" placeholder="PHONE">
             
            </div>

            <div class="col-md-6 form-group">
            
                <input class="form-control inout-size" type="text" id="subject" placeholder="SUBJECT">
             
            </div>

            <div class="col-md-12">
              <div class="form-group mycmnt">
                <textarea class="form-control" rows="10" id="comment" placeholder="MESSAGE"></textarea>
              </div>
              <button type="button" class="btn btn-default btn-lg btn-block send-button">SEND MESSAGE</button>
            </div>
          </div>
