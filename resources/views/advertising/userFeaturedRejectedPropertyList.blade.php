                             ...
                             <div class="row">
								...
								<div class="col-lg-12">
									<div class="panel panel-default card-view recent-add-class-padding">
										<h6 class="panel-title add-heading-text txt-dark mt-20">Rejected Featured Properties</h6>
												...
												<div class="table-wrap">
													<div class="table-responsive">
														<table id="user_active_property" class="table table-hover display  pb-30" >
															...
															<tbody>
																<?php $i=1?>
															@foreach($allRejectedFeaturedProperties as $allRejectedFeaturedPropertie)
																<tr>
																	<td><?php echo $i?></td>
																	<td>{{$allRejectedFeaturedPropertie->p_id}}</td>
                                                					<td>{{$allRejectedFeaturedPropertie->title}}</td>
                                                					<td>{{date('M jS, Y',strtotime($allRejectedFeaturedPropertie->p_created_at))}}</td>
                                                					<td>{{$allRejectedFeaturedPropertie->p_address}}</td>
																	<td>ali@gmail.com</td>
																	<td class="phn-email"><span>{{$allRejectedFeaturedPropertie->mobile}}</span><span>{{$allRejectedFeaturedPropertie->email}}</span></td>
																	...
																	<td><a href="javascript:void(0);" class="btn btn-sm add-property-hot">{{$allRejectedFeaturedPropertie->pkg_name}}</a></td>
																</tr>
															        ...
															        <div class="modal-dialog">
															            <div class="modal-content">
															                ...
															                <div class="modal-body model-popup">
																                ...
																                <p>{{$allRejectedFeaturedPropertie->reject_reason}} </p>
							...
							<div class="row">
								<div class="page-nation">
									<ul class="pagination pagination-large">
                                        {{$allRejectedFeaturedProperties->links()}}
