            ...
            <div class="col-lg-12 col-sm-12">
                <div  class="tab-struct custom-tab-2 mt-30 edit-payment-method">
                    <div class="col-md-12 padding-left padding-right">
                        <div class="form-wrap">
                            <form action="/saveAccountDetail/{{$paidProperty->id}}" class="form-horizontal ">
                            {{ csrf_field() }}
									...
									<div class="row">
                                        <div class="col-md-12 padding-left padding-right">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-12 padding-right padding-left">
                                                    <input type="text" class="form-control" name="property_id" value="{{$paidProperty->property_id}}" disabled>

                                                    <input type="hidden" name="p_id" value="{{$paidProperty->property_id}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-9 col-sm-12 padding-right padding-left">
                                                    <select class="selectpicker" id="pkg" data-url="/getPackagedetail/" title="---- Select Package ----" name="package_id" data-style="form-control btn-default btn-outline">
														<?php 
                                                            ...
                                                            @if($paidProperty->package_id == $package->id)
                                                            <?php 
                                                            $selected = "selected"; 
                                                            ?>
									...
									<div class="row">
                                        <div class="col-md-12 padding-left padding-right">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-12 padding-right padding-left">
                                                    <input type="text" class="form-control" id="pkg_price" name="package_price" value="{{$paidProperty->price}}" placeholder="Enter Package Amount">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 padding-left padding-right">
                                            <div class="form-group mrbtm-zero">
                                                ...
                                                <div class="col-md-9 col-sm-12 padding-right padding-left">
                                                    <input type="text" class="form-control specific-bg" id="total_amount" name="total_amount" value="{{$paidProperty->price}}" placeholder="Your Total Amount">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
