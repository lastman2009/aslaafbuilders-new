            ...
            <div class="col-lg-12 col-sm-12">
                <div  class="tab-struct custom-tab-2 mt-40">
                    <div class="tab-content">
                        <form action="/dashboard/privatePolicy/update" class="form-horizontal" method="post" enctype="multipart/form-data">
        						{{ csrf_field() }}
                            <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 blog-portion padding-left">
                                        <div class="panel panel-default card-view blog-image-height">
                                            <div class="panel-wrapper collapse in">
                                                <h2 class="whyus-heading">Privacy Policy</h2>
														...
														<div class="col-md-12 padding-right">
															...
															<div class="col-md-12 padding-left">
																<div class="form-group">
																	<textarea class="form-control summernote" rows="8" cols="50" name="contant" id="" placeholder="Content ...">{{$privacyPolicy->contant}}</textarea>
