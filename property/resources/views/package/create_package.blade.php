                ...
                <div class="panel panel-default card-view mt-30">
                    <div class="panel-wrapper collapse in category-multi newmulti pkgtitle">
                        ...
                        <div class="panel-body add_product add_tags"> 
                            <form action="/savePackage" class="form-horizontal" method="post" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker" title="Select Category" name="adcategory_id" data-style="form-control btn-font btn-default btn-outline">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker" title="Select Page" name="adpage_id" data-style="form-control btn-font btn-default btn-outline" required>
                                        ...
                                        <option value="{{$adPage->id}}">{{$adPage->name}}</option>
                                         @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                <label class="col-lg-12 control-label mb-10 text-left padding-left">Duration ( In Days)</label>
                                    <input class="form-control" type="text" id="duration" name="duration" placeholder="3"  required />
