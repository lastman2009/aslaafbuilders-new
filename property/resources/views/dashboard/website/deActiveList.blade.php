@php
$title = "De-Activate List For Website Agency";
@endphp
                ...
                <div class="panel panel-default card-view user-list-section">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <h2>De-Active  List For Agency Website</h2>
                                ...
                                <div class="panel panel-default card-view user-list-portion">
                                    <div class="panel-wrapper collapse in">
                                        <div class="panel-body">
                                            ...
                                            <form class="" action="/dashboard/admin/search/deactivated/website" method="POST">
                                                {{ csrf_field() }}
                                                <div class="">
                                                ...
                                                <table id="datatable-userlist" class="table table-striped table-bordered mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" class="active" name="activate" id="{{$activation_request->id}}">
                                                        </td>
                                                    </tr>                  
                                                    @endforeach
                                                    </tbody>
