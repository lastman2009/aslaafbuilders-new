															...
															<div class="col-md-6 padding-left">
																<div class="form-group">
																	...
																	<select name="town_id" id="town" class="selectpicker townclass" data-style="form-control btn-font btn-default btn-outline" title="--Nothing Selected--" required>
																		...
																		<option value="{{ $city->id }}" selected>{{$town->name}}</option>
																		@else
												...
												<div class="panel panel-default card-view propertytypeheight">
										    		...
										    		@endif
																				...
																				<div class="col-md-4 padding-left padding-right">
																					<div class="form-group">
																						...
																						<select name="min_area_type_residential" class="selectpicker" data-style="form-control btn-font btn-default btn-outline" title="Type" required>
										    		...
										    		@endif
																				...
																				<div class="col-md-4 padding-left padding-right">
																					<div class="form-group">
																						<label class="control-label mb-10" for="email_de">&nbsp;</label>
																						<select name="max_area_type_residential" class="selectpicker" data-style="form-control btn-font btn-default btn-outline" title="Type" required>
																							@foreach($areas as $area)
										    		...
										    		@endif
																				...
																				<div class="col-md-4 padding-left padding-right">
																					<div class="form-group">
																						<label class="control-label mb-10" for="email_de">&nbsp;</label>
																						<select name="min_area_type_commercial" class="selectpicker" data-style="form-control btn-font btn-default btn-outline" title="Type" required>
																							@foreach($areas as $area)
										    		...
										    		@endif
																				...
																				<div class="col-md-4 padding-left padding-right">
																					<div class="form-group">
																						<label class="control-label mb-10" for="email_de">&nbsp;</label>
																						<select name="max_area_type_commercial" class="selectpicker" data-style="form-control btn-font btn-default btn-outline" title="Type" required>
																							@foreach($areas as $area)
