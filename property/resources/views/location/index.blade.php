	...
	<div>
		...
		<!-- <a href="#" class="editTown">Town Edit</a> -->
				...
				<div id="phase-check" class="form-group" >
					...
					<input type="text"  class="form-control"  name="phase" id="phaseinput" placeholder="phase" required="" ><br>
				...
				<div id="block-check" class="form-group">
					...
					<input type="text"  class="form-control"  name="block" required placeholder="block" >
