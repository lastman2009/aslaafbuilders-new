									...
									<table id="blog-listing" class="table mb-0 table-class">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
					                        	...
					                        	<td>
													<a href="#" data-id="{{$category->id}}" class="delete mr-5" data-toggle="tooltip" data-original-title="Delete"> 
                                                        <i class="fa fa-trash-o text-inverse m-r-10"></i> 
                                                    </a>
													<a href="{{ route('category.edit', $category->id) }}" data-toggle="tooltip" data-original-title="Edit">
