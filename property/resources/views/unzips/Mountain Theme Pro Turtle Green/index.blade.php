...
<head>
    ...
    <link rel="stylesheet" href="/unzips/Mountain%20Theme%20Pro%20Turtle%20Green/css/main.css">
            ...
            <div class="home-content-tablecell">
                <div class="row">
                    <div class="col-twelve">
                        ...
                        <img src="/unzips/Mountain%20Theme%20Pro%20Turtle%20Green/images/banner-line.png" alt="banner-line"></div>
                    <!-- end col-twelve -->
                </div>
                <!-- end row -->
            </div>
                                    ...
                                    <!-- <a href="/property/{{App\Property::getPurpose($property->purpose)}}/{{App\Property::getCityName($property->city_id)}}/{{App\Property::getTownName($property->town_id)}}/{{App\Property::getTitleSlug($property->title)}}/{{$property->id}}"> -->
                                        ...
                                        <div class="facebook-icon">
        									<div class="team-text">
        										...
        										<img src="/unzips/Mountain%20Theme%20Pro%20Turtle%20Green/images/line.jpg" alt="img-line" />
                                                <ul>
                                                    <li>
