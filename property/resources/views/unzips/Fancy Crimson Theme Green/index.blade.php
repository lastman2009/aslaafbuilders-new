...
<head>
    ...
    <link href="/unzips/Fancy%20Crimson%20Theme%20Green/css/theme.css" rel="stylesheet">
    <link href="/unzips/Fancy%20Crimson%20Theme%20Green/css/custom.css" rel="stylesheet">
    <style>
        .banner{
            <?php 
                $active_index = 0;
            ...
            @if(!$agencyWebsite->Images->isEmpty())
                ...
                @endif
            @else
                background-image: url(../unzips/Fancy%20Crimson%20Theme%20Green/images/banner.jpg);
            @endif
            height:750px;
            position:relative;
...
<script src="/unzips/Fancy%20Crimson%20Theme%20Green/js/jquery-3.2.1.min.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Green/js/jquery-migrate-3.0.0.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Green/js/bootstrap.min.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Green/http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
<script src="/unzips/Fancy%20Crimson%20Theme%20Green/js/owl.carousel.js"></script>
