...
<head>
    ...
    <link href="/unzips/Slanting%20Theme%20Pro/css/bootstrap.min.css" rel="stylesheet">
    <link href="/unzips/Slanting%20Theme%20Pro/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="/unzips/Slanting%20Theme%20Pro/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="/unzips/Slanting%20Theme%20Pro/css/jquery.mCustomScrollbar.css">
    <link href="/unzips/Slanting%20Theme%20Pro%20Dark%20Golden%20Rod/css/theme.css" rel="stylesheet">
    <link href="/unzips/Slanting%20Theme%20Pro%20Dark%20Golden%20Rod/css/custom.css" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 banner-text">
                    ...
                    <h1>Choose Your Favourite House</h1>
                    ...
                    <div class="col-lg-12 pr">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 about-img-section pl">
                            <div class="img-container">
                                <div class="img-block">
                                    <img class="img-responsive" src="/unzips/Slanting%20Theme%20Pro%20Dark%20Golden%20Rod/images/about-img.jpg" alt="About {{$agencyWebsite->agency_name}}"></div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <figure>
                                    ...
                                    <div class="abc">
                                        <a href="/property/{{App\Property::getPurpose($property->purpose)}}/{{App\Property::getCityName($property->city_id)}}/{{App\Property::getTownName($property->town_id)}}/{{App\Property::getTitleSlug($property->title)}}/{{$property->id}}">
                                            ...
                                            <span class="facebook-icon"><img src="/unzips/Slanting%20Theme%20Pro%20Dark%20Golden%20Rod/images/project-open.png" alt=""></span>
                                    ...
                                    <figcaption>
                                        ...
                                        <div class="property-detail">
                                            <div class="col-md-6 col-sm-6 property-description pl pr">
                                                <a href="/property/{{App\Property::getPurpose($property->purpose)}}/{{App\Property::getCityName($property->city_id)}}/{{App\Property::getTownName($property->town_id)}}/{{App\Property::getTitleSlug($property->title)}}/{{$property->id}}">
													<img src="/unzips/Slanting%20Theme%20Pro/images/property-photo.png" alt="">
                                                    <p>
                                                        @if($count !== 0)
                                                        {{$count}}
                                                        @else
                                            ...
                                            <div class="col-md-6 col-sm-6 property-description pl pr">
                                                <a href="/property/{{App\Property::getPurpose($property->purpose)}}/{{App\Property::getCityName($property->city_id)}}/{{App\Property::getTownName($property->town_id)}}/{{App\Property::getTitleSlug($property->title)}}/{{$property->id}}">
													<img src="/unzips/Slanting%20Theme%20Pro/images/property-square.png" alt="">
                                                    <p>
                                    ...
                                    <figcaption>
                                        ...
                                        <div class="team-detail">
                                            <div class="col-md-6 col-sm-6 team-description pl pr">
                                                <a href="">
														<img src="/unzips/Slanting%20Theme%20Pro%20Dark%20Golden%20Rod/images/team-phone.png" alt=""><p>{{$staff->contact_number}}</p>
													</a>
                                            </div>
                                            <div class="col-md-6 col-sm-6 team-description pl pr">
                                                <a href="">
														<img class="team-service-img" src="/unzips/Slanting%20Theme%20Pro%20Dark%20Golden%20Rod/images/team-service.png" alt=""><p>{{$staff->year_of_service}} Year services</p>
													</a>
                                            </div>
                                        </div>
                                    </figcaption>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-3 col-md-3 <?php if($officeNum == 1){echo "col-md-offset-5 ";}elseif($officeNum == 2){echo "col-md-offset-2";}elseif($officeNum == 3){echo "col-md-offset-1";}?> location-addresses">
    ...
    <script src="/unzips/Slanting%20Theme%20Pro/js/jquery-3.2.1.min.js"></script>
    <script src="/unzips/Slanting%20Theme%20Pro/js/bootstrap.min.js"></script>
    <script src="/unzips/Slanting%20Theme%20Pro/js/owl.carousel.js"></script>
    <script src="/unzips/Slanting%20Theme%20Pro/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script>
