                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-8 text-center pl-0 pr-0 data-wrap-left">
                                            <span class="txt-light block counter"><span class="counter-anim">{{$statictics->total_featured_properties}}</span></span>
...
<div class="row top-panelbox" style="margin-right: -10px; margin-left: -10px;">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-left-right">
                <div class="panel panel-default card-view pa-0">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body pa-0">
                            <div class="sm-data-box" style="background-color:#3f51b5">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-7 text-center pl-0 pr-0 data-wrap-left">
                                            <span class="txt-light block counter"><span class="counter-anim">{{$statictics->total_user}}</span></span>
                                            <span class="weight-500 uppercase-font txt-light block font-15">Total User</span>
                                        </div>
                                        <div class="col-xs-5 text-center  pl-0 pr-0 data-wrap-right">
                                            <img class="top-color-icon" src="assets_admin/dist/img/wanted-list.png" alt="" />
                                        </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-left-right">
                <div class="panel panel-default card-view pa-0">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body pa-0">
                            <div class="sm-data-box" style="background-color:#795548">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-7 text-center pl-0 pr-0 data-wrap-left">
                                            <span class="txt-light block counter"><span class="counter-anim">{{ $today_signup }}</span></span>
                                            <span class="weight-500 uppercase-font txt-light block font-15">Today Sign up</span>
                                        </div>
                                        <div class="col-xs-5 text-center  pl-0 pr-0 data-wrap-right">
                                            <img class="top-color-icon" src="assets_admin/dist/img/heart.png" alt="" />
                                        </div>
                ...
                <div class="panel panel-default card-view">
                    ...
                    <div class="panel-heading">
                        <div class="pull-left" style="width:100%;text-align:center;">
                            <h6 class="panel-title txt-dark chart_heading"><div id="embed-api-auth-container"></div></h6>
                        </div>
                        ...
                        <div class="panel-body"> 
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 padding-left">
                                <div class="panel-boxes">
                                    <div id="chart-1-container"></div>
                                    <div id="view-selector-1-container" style="display:none"></div>
                                </div>  
                            </div>
                            <div class="col-lg-6 col-md-6 col-xs-12 padding-left padding-right">
                                <div class="panel-boxes">
                                    <div id="chart-2-container" style="display:none"></div>
...
<!--- One more row end -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default card-view recent-add-class-padding">
                    ...
                    <a href="@if(Auth::user()->role_id == 1)/dashboard/admin/property/pending @else /dashboard/property/pending @endif" class="btn btn-success" style="float: right;margin-top: -30px;"><span>View More</span></a>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">    
                                ...
                                <div class="panel-boxes">
                                    <a href="@if(Auth::user()->role_id == 1)
                                        ...
                                        <div class="panel-dashboard border-panel text-center">
                                            ...
                                            <h2 class="col-green">{{$statictics->active_blogs}}</h2>
                        ...
                        <div class="panel-body panel-box">
                            <a href="@if(Auth::user()->role_id == 1)
                                ...
                                <div class="panel-dashboard text-center">
                                    ...
                                    <h2 class="col-blue">
                                        @if(Auth::user()->role_id == 1)
                                       {{$statictics->total_user}}
                                        @else
                                        {{$statictics->total_estate_agent}}
                                        @endif
                                    </h2>
                                    <p>Registered 
                                        @if(Auth::user()->role_id == 1) 
        ...
        <div class="row">
                ...
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark chart_heading">Daily SignUp</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                             <div id="morris_bar_chart1" class="morris-chart"></div>
                        </div>
                    </div>
                </div>  
            </div>
            <div class="col-lg-6 pr-right">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark chart_heading">OutHouse</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                             <div id="out-house" class="morris-chart"></div>
                        </div>
                    </div>
                </div>  
            </div>
     ...
     @if(Auth::user()->role_id == 1 )
       ...
       // Bar Chart
        Morris.Bar({
            ...
            data: [
            <?php $i = 0; ?>
            @if(!$daily_signups->isEmpty())
            @foreach($daily_signups as $views)
                {
                    device: '{{date('d-M-y', strtotime($views->created_at))}}',
                    geekbench: {{$views->count}}     
                }
                <?php
                    if((count($daily_signups)) != $i){ 
                        echo ",";
                    }
                    $i++;
                ?>
        ...
        if($('#out-house').length > 0){
       // Bar Chart
        Morris.Bar({
            element: 'out-house',
            data: [
            <?php $i = 0; ?>
            @if(!$outHouse_properties->isEmpty())
            @foreach($outHouse_properties as $views)
                {
                    device: '{{date('d-M-y', strtotime($views->created_at))}}',
                    geekbench: {{$views->count}}     
                }
                <?php
                    if((count($outHouse_properties)) != $i){ 
                        echo ",";
                    }
                    $i++;
                ?>
...
gapi.analytics.ready(function() {
  ...
  gapi.analytics.auth.authorize({
    ...
    clientid: '232901153834-8rhdqu6co1utmgogog30jqcb8g3vqae7.apps.googleusercontent.com'
  });
