                ...
                <div class="panel panel-default card-view add_product">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                             <form action="/updateproduct" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea-product" value="{{$userProduct->description}}" rows="5" name="description"></textarea>
                                </div>
