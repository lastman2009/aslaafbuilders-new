                                            ...
                                            <div class="panel panel-default card-view profile-Image-tab">
                                               <div class="row">
                                                ...
                                                <div class="panel-wrapper collapse in">
                                                    <div class="panel-body profile-role portfolio-imgs">
                                                       
                                                     <div class="col-md-3">
                                                            <img src="dist/img/portfolio-img.jpg">
                                                    ...
                                                    <div class="add-meore-images">
                                                    <span class="input-group-btn">
                                                        <span class="btn btn-default btn-file">
                                                            Add more images <input id="imgInp" type="file">
                                                        </span>
                                                    </span>
                                                    </div>


                                                   <!--  <div class="browseImg add-meore-images">
                                                        <input type="file"> Add more images</div> 
                                                </div> -->
                                                </div>
                                                </div>
                                            </div>
