    ...
    <div class="container-fluid">
		 ...
		 <div class="row">
            <div class="col-lg-12 mt-40 inventory-search">
                <div class="panel panel-default card-view inventory-add-class-padding">
                    <h6 class="panel-title inventory-add-class txt-dark">Real Estate Directory Search.</h6>
									...
									<div class="col-md-12">
										<div class="col-md-6 padding-left">
											<div class="form-group">
												<input type="text" class="form-control inventory-area" placeholder="Agency Name">
											</div>
										</div>
										<div class="col-md-6 padding-left">
											<div class="form-group">
												<input type="text" class="form-control inventory-area" placeholder="Agency ID">
											</div>
										</div>
										<div class="col-md-6 padding-left">
										...
										<div class="col-md-12 padding-left">
											<button type="submit" class="btn btn-submit-webinfo btn-client btn-anim" style="margin-top:15px;"><i class="fa fa-search"></i><span class="btn-text">Search</span></button>
										</div>
									</div>
								</div>
							</form>
        ...
        <div class="row">
            <div class="col-lg-12 inventory-search">
                <div class="panel panel-default card-view inventory-add-class-padding">
                    <h6 class="panel-title inventory-add-class client-list-heading txt-dark">Real Estate Directory Search Result.</h6>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">	
