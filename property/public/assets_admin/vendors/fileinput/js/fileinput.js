...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer" style="height: 90px;">\n' +
                '    <div class="file-footer-caption" title="{caption}">{caption}<br>{size}</div>\n' +
                '    {progress} {indicator} {actions}\n' +
                '</div>';
            tActions = '{drag}\n' +
                '<div class="file-actions" style="    position: relative;text-align: center;display: block;top: -15px;">\n' +
                '    <div class="file-footer-buttons delete_zoom" style="float:none;">\n' +
                '        {upload} {delete} {zoom} {other}' +
                '    </div>\n' +
                '    <div class="clearfix"></div>\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<button type="button" class="kv-file-remove {removeClass}" style="float: left;padding:4px 25px !important;" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
            // tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
            //     '{uploadIcon}</button>';
                 tActionUpload = '';
            tActionZoom = '<button type="button" class="kv-file-zoom {zoomClass}" style="float: right;" ' +
